	...
	public static void main(String[] args) {
		...
		/*
		  ...
		  - 메소드의 인자 리스트를 다양한 형태로 구성해서,
		   ...
		   메소드를 여러개 선언할 예정
		  	1. public static void test() {} 			//0
		  	2. public static void test() {} 			//X, 1번
		  	3. public static void test(int n) {} 		// O
		  	4. public static void test(int m) {} 		// X. 3번 구분X 매개변수 이름은 함정!!
		  	5. public static void test(String s) {} 	// O.
		  	6. public static void test(int n, int m) {} // O. 개수다르면 인정
		  	7. public static int test() {} 				// X. 호출할때 1번 구분X
