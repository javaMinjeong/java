...
public class Ex15_Operator {
	...
	public static void main(String[] args) {
		...
		//*** 모든 산술 연산자의 결과 자료형은 
		//	  두 피연산자의 자료형 중 더 크기가 큰 자료형으로 반한된다.
		...
		System.out.println(e + f); // OverFlow 30억 > -1,294,967,296
		System.out.println((long)e + f); // 형 변환 통하여 30억 출력
		
		e = 300000;
		f = 500000;
		
		System.out.println(e * f); // OverFlow -323855360
		System.out.println(e * (long)f); // OverFlow -323855360
				
		e = -2100000000;
		f = 100000000;
		
		System.out.println(e - f); // UnderFlow 2,094,967,296
		...
		//예외 상황 > byte, short 연산결과는 무조건 int 이다 > CPU 처리 단위
		//byte + byte = byte(X)
		//byte + byte = int(O)
		//short + short = short(X)
		//short + short = int(O)
