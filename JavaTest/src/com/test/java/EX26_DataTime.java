...
public class EX26_DataTime {
	...
	private static void m8() {
		...
		//전용 메소드(현재 시각의 tick을 구하는 전용 메서드)
	...
	private static void m7() {
		...
		//a.set(Calendar.HOUR, 2); //두시간 아니고 두시 양을 나타냄
	...
	private static void m6() {
		...
		System.out.println(nowTick); // 1689898952711ms

		
		long endTick = end.getTimeInMillis();
		System.out.println(endTick); //1703636711395ms
	...
	private static void m2() {
		...
		//[time=1689838507135,areFieldsSet=true,areAllFieldsSet=true,lenient=true,zone=sun.util.calendar.ZoneInfo[id="Asia/Seoul",offset=32400000,dstSavings=0,useDaylight=false,transitions=30,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=2023,MONTH=6,WEEK_OF_YEAR=29,WEEK_OF_MONTH=4,DAY_OF_MONTH=20,DAY_OF_YEAR=201,DAY_OF_WEEK=5,DAY_OF_WEEK_IN_MONTH=3,AM_PM=1,HOUR=4,HOUR_OF_DAY=16,MINUTE=35,SECOND=7,MILLISECOND=135,ZONE_OFFSET=32400000,DST_OFFSET=0]
		...
		System.out.printf("지금은 오후 %d시 %02d분 %2d초 입니다.\n"
							, c1.get(Calendar.HOUR_OF_DAY)
							, c1.get(Calendar.MINUTE)
							, c1.get(Calendar.SECOND));
		
		System.out.printf("지금은 %s %d시  %02d분 %2d초 입니다.\n"
