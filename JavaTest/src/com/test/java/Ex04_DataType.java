...
public class Ex04_DataType {
	...
	public static void main(String[] args) {
		...
		System.out.println(100); //점수 100점 > 100 상수
		...
		System.out.println(100); //국어 점수 출력 > 가독성 낮음 > 의미X
...
//		
		...
		/*
		 * byte x2, y2; //마트 x좌표, 마트 y좌표 byte x3, // 마트 x좌표 y3; // 마트 y좌표
		 */
		...
		byte EnglishScore; // 파스탈 표기법 가독성 높음
