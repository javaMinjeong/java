...
//}
	...
	private static void q42() {
		...
		System.out.printf("2023년 7월 25일은 %,d일째 되는 날이고 %s요일 입니다.\n",sum,day);
	...
	private static void q39() {
		...
		System.out.println("\b\b=" + sum); //이클립스제외하면 필요한 코드
	...
	private static void m3() {
		...
		for(int i=1; i<=6; i++) {
			...
			for(int j=1; j<=30; j++) {
				...
				//if(i==5 && j == 5) {
				if(i==5 || j == 5) {
					break; // 자신이 포함된 제어문을 탈출한다.(j포문 탈출. i포문 관련 없음)
				}
