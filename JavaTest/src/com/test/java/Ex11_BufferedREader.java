...
public class Ex11_BufferedREader {
	public static void main(String[] args) throws Exception{
		...
		/*
		  System.out.print("첫번째 숫자: "); String input1 = reader.readLine(); // "5"
		  
		  System.out.print("두번째 숫자: "); String input2 = reader.readLine(); // "3"
