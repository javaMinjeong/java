...
public class Ex05_Variable {
  ...
  public static void main(String[] args) {
	...
	b1 = Byte.MAX_VALUE; //byte가 가질 수 있는 최대값  
	System.out.println(b1);
	
	b1 = Byte.MIN_VALUE; //byte가 가질 수 있는 최솟값  
	System.out.println(b1);
	...
	l1 = 3000000000L; //정수형 상수 무조건 4byte(int)
	System.out.println(l1);
	...
	System.out.println(f1); //1.2345679000000000000000
	System.out.println(d1);	//1.2345678901234568000000
	...
	name = "홍길동"; //문자열 상수(리터럴) 표기법 절대 엔터 금지** 
	...
	System.out.println(a1 + " + " + a2 + " = "+ (a1 + a2)); // +연산자는 무조건 왼쪽부터 실행
