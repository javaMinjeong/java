...
public class Ex17_Operator {
		...
		public static void main(String[] args) {
			...
			/*
			  ...
			  - 1항 연산자 
			  - 피연산자는 숫자형을 가진다.
			  - 누적 연산을 한다. 기존의 값에 1을 더하거나, 1을 뺀다. (오직 1만 가능)
			 
			  			
			  *** 연산자의 위치를 바꿀 수 있다. > 위치에 따라 연산자 우선 순위가 달라진다.
...
//			result = 10 + ++n;
			...
			System.out.printf("입력한 나이 %d세는 %d입니다. \n", age, result);
