...
public class Ex29_for {
	...
	public static void m14() { //void 리턴 X
	...
	public static int m13() {
		...
		if (num % 2 == 0) { //false일경우 return값 없음
			
			return 10;
		}else {	// else절 추가로 true false 끝 return문 다 만남
			return 0;
		}
	...
	private static void m11() {
		// 요구사항] 사용자로부터 숫자를 입력 > 입력받은 숫자 누적> 입력 횟수? > m6()
		// 추가사항] 홀수만 입력 ~ (짝수는 프로그램 종료)
		...
		for(;;) {
			...
			if(num%2 ==0) {	//짝수 입력
				break; 		//자신이 속한 for문 빠져나감
				//return;	// 자신이 속한 메소드 빠져나감, 드물게 사용
...
//			}
	...
	private static void m9() {
		...
		//break, continue > 독립적 사용 불가 > 독립 제어문과 함께 사용
		//break > 자신이 속한 제어문을 탈출(if문 예외, if문 인식 불가)
		...
		for (int i =1; i<=10; i++) {
			...
			if(i==5) {
				...
				//break; //for문 탈출, 완전히 끝남
				continue; //해당 숫자 밑으로 출력 불가능하고 바로 처음으로, 이번 횟수만 쉴게요
			}
...
//		for(int i=0; ; i++) { //아무것도 안적어도 true로 실행해줌
//			System.out.println(i);
//		}
		
//		for(; ; ) { //아무것도 안적어도 실행해줌, 무한루프
...
//		}
	...
	private static void m1() {
		...
		for (int i=1; i<=5; i++) {
			System.out.println("안녕하세요."); //자동으로 5회 반복
		}
